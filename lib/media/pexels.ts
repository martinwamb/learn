...
// Pexels is a fully curated, editorially-moderated stock library (no user uploads),
// so there's no safe-search API param to set -- moderation happens on their end.
